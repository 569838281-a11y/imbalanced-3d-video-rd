# Stage-3b: Macula Detached TD vs Bilateral — Swin-UNETR + SSL, freeze-then-finetune
$ErrorActionPreference = "Continue"
$repo = "C:\Users\ADMIN\Desktop\test_5"
$ckptDir = "D:\ERDES\checkpoints\stage3_detached_swin_ssl_protect_50ep"
$py = "D:\anaconda3\envs\erdes\python.exe"
$logFile = "D:\ERDES\logs\stage3_detached_swin_ssl_protect_train.log"
...
& $py -u erdes/train.py `
  experiment=macula_detached_td_vs_bilateral/swinunetr_ssl_protect_50ep_local `
  $ckptArg `
  extras.print_config=false `
  test=false `
  'callbacks.model_summary=null' `
  tags=[erdes,swin,ssl_protect,stage3,detached,50ep] `
